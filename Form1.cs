...
namespace tehenAdatok
{
    public partial class Form1 : Form
    {
        ...
        {
            InitializeComponent();
            comboBox1.Items.Add("Hétfõ");
            comboBox1.Items.Add("Kedd");
            comboBox1.Items.Add("Szerda");
            comboBox1.Items.Add("Csütörtök");
            comboBox1.Items.Add("Péntek");
            comboBox1.Items.Add("Szombat");
            comboBox1.Items.Add("Vasárnap");
            comboBox1.SelectedIndex = 2;
            trackBar1.Value = 20;
            label6.Text = "Beállított érték: " + trackBar1.Value.ToString() + " liter";
        }
        ...
        {
            label6.Text = "Beálított érték: " + trackBar1.Value.ToString() + " liter";
        }
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (var i in Cows)
            {
                ...
                tfejes_menny= int.Parse(i.Split(";")[2]);
                    ...
                    {
                        if (tfejes_menny == 0)  MessageBox.Show("Nem volt fejés");
                        if (tfejes_menny < fejes_menny) MessageBox.Show("Az adott napon a mennyiség nem érte el a limitet");
                        if (tfejes_menny >= fejes_menny) MessageBox.Show($"Az adott mennyiség {tfejes_menny} liter volt");
                    }
            }
            bool talalt = false;
            foreach (var i in Cows)
            ...
            if(talalt==false) MessageBox.Show("Nem volt fejés");
        }
    }
}
